...
final_mysql_name = 'sy_csc_fsp_department_daily_wang'
...
try:
    ...
    data_list = dbname[mongo_name].find({"gtime": {"$gt":1592874909}, 'branch_tree.1':'河北', 'article_info.类型':'失信黑名单'}).limit(100)
