...
# print(secuCodeList[2500:2501], len(secuCodeList))
# # 计算增量数据pe值
# for secuCode in secuCodeList[2500:3000]:
    # # 计算增量数据pe值
...
print(all_secu_code_list[3000:3001], len(all_secu_code_list))
...
# 分为点计算
i = 3000
for secuCode in all_secu_code_list[3000:3500]:
