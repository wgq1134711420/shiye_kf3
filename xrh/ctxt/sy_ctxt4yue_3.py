...
# print(secuCodeList[3000:3001], len(secuCodeList))
# # 计算增量数据pe值
# for secuCode in secuCodeList[3000:3500]:
    # # 计算增量数据pe值
...
print(all_secu_code_list[3500:3501], len(all_secu_code_list))
...
# 分为点计算
i = 3500
for secuCode in all_secu_code_list[3500:4000]:
