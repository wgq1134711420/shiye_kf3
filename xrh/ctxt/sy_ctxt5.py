...
print(all_secu_code_list[3900:3901], len(all_secu_code_list))
...
# 分为点计算
i = 3900
for secuCode in all_secu_code_list[3900:3950]:
    ...
    print('插入表sy_ctxt_main_assess_value_daily数据成功',secuCode,str(i))
    i += 1
