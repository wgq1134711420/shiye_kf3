...
totmktcap_max_trade_date = '20201113'
...
# print(secuCodeList[:1], len(secuCodeList))
# i = 1
# for secuCode in secuCodeList:
#     # 计算增量数据pe值
...
#     mysql_conn.commit()
#     print('{}-{}-插入表sy_ctxt_main_pe数据成功'.format(i, secuCode))
#     i += 1
...
print(all_secu_code_list[:1], len(all_secu_code_list))

# 分为点计算
i = 1
for secuCode in all_secu_code_list:
