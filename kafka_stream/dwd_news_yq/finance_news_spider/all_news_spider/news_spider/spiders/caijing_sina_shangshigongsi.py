...
class MySpider(RedisSpider):
    name = 'caijing_sina_shangshigongsi'
    allowed_domains = ['finance.sina.com.cn']
    ori_path = settings.get('ORI_PATH')
    encoding = "utf-8"
    start_urls = [
        "http://finance.sina.com.cn/roll/index.d.html?cid=56592&page=1",
        "http://finance.sina.com.cn/roll/index.d.html?cid=56592&page=2"
    ]
    headers = {
