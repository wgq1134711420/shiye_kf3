...
class MySpider(RedisSpider):
    name = 'caijing_sina_guonei'
    allowed_domains = ['finance.sina.com.cn']
    ori_path = settings.get('ORI_PATH')
    encoding = "utf-8"
    start_urls = [
        "http://feed.mix.sina.com.cn/api/roll/get?pageid=155&lid=1686&num=10&page=1&callback=feedCardJsonpCallback",
        "http://feed.mix.sina.com.cn/api/roll/get?pageid=155&lid=1686&num=10&page=2&callback=feedCardJsonpCallback",
        "http://feed.mix.sina.com.cn/api/roll/get?pageid=155&lid=1686&num=10&page=3&callback=feedCardJsonpCallback",
        "http://feed.mix.sina.com.cn/api/roll/get?pageid=155&lid=1686&num=10&page=4&callback=feedCardJsonpCallback",
        "http://feed.mix.sina.com.cn/api/roll/get?pageid=155&lid=1686&num=10&page=5&callback=feedCardJsonpCallback",
    ]
    headers = {
