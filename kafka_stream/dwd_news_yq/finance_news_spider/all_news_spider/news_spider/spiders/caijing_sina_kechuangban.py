...
class MySpider(RedisSpider):
    name = 'caijing_sina_kechuangban'
    allowed_domains = ['finance.sina.com.cn']
    ori_path = settings.get('ORI_PATH')
    encoding = "utf-8"
    start_urls = [
        "http://interface.sina.cn/pc_api/public_news_data.d.json?cids=239198%2C239199%2C239200%2C239201%2C239202&pdps=&smartFlow=&editLevel=0%2C1%2C2%2C3&type=std_news%2Cstd_slide%2Cstd_video&pageSize=20&mod=nt_category_finance_fund_hot&cTime=1483200000&up=0&action=0",
    ]
    headers = {
